...
use App\Http\Controllers\Admin\MaterialPurchaseTransactionController;
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('materials/recipes', [MaterialController::class, 'saveRecipe'])->name('materials.recipes');
    Route::resource('material-purchases', MaterialPurchaseController::class)->only(['index', 'store', 'update', 'destroy']);
    Route::post('material-purchases/{materialPurchase}/transactions', [MaterialPurchaseTransactionController::class, 'store'])->name('material-purchases.transactions.store');
    Route::get('material-purchases/{materialPurchase}/pdf', [MaterialPurchaseController::class, 'pdf'])->name('material-purchases.pdf');
